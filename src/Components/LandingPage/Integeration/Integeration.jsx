  ...
  return (
    <Container>
      <div>
        ...
        <div>
          <div>
            <img src="https://logos-world.net/wp-content/uploads/2021/02/Asana-Symbol.png" alt="asana-logo"/>
            <p>Asana</p>
          </div>
          <div>
          ...
          <div>
            <img src="https://logos-world.net/wp-content/uploads/2021/02/Jira-Emblem.png" alt="Jira"/>
            <p>Jira</p>
          </div>
          <div>
      ...
      <div>
        ...
        <button onClick={() => handleSliderImg(1)} ><BsChevronLeft/></button>
        <button onClick={() => handleSliderImg(-1)}><BsChevronRight/></button>
      </div>

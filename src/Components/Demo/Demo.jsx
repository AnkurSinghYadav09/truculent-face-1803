          ...
          <Center>
            ...
            >
              ...
              <ul>
                ...
                <li style={{ color: "#56BB70" }}>
                  <Text color="#7F7F7F" fontSize="10px">
                    We’ll answer all questions about setting up Everhour, using
                    it with your team, or anything else you’d like to ask.
                  </Text>
                </li>
              </ul>
              <br />
              ...
              <ul>
                <li style={{ color: "#56BB70" }}>
                  <Text color="#7F7F7F" fontSize="10px">
                    ...
                    software using this link. Please ensure that your mic and
